/*
 * @Author: MarioGo
 * @Date: 2021-10-05 10:44:37
 * @LastEditTime: 2021-10-05 11:53:10
 * @LastEditors: MarioGo
 * @Description: 文件描述
 * @FilePath: /flutter_24/lib/components/DraggableGridView.dart
 * 可以输入预定的版权声明、个性签名、空行等
 */
/*
 * @Author: MarioGo
 * @Date: 2021-10-03 22:13:39
 * @LastEditTime: 2021-10-05 10:41:14
 * @LastEditors: MarioGo
 * @Description: 文件描述
...
class _SortableGridViewState<T> extends State<SortableGridView> {
  late bool showDeleteIcon = false;
